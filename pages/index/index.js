...
Page({
    ...
    let list=[
      {
        ...
        tag: '秩序册',
        author: "智慧体育",
        cover: "http://img.hodays.com//images/undefined/activity//20180228/1519754178269_0_0.mp4",
      ...
      },
      {
        ...
        tag: '新闻',
        author: "喜爱运动",
        cover: "http://img.hodays.com//images/004/activity//20180502/1525233759869_0_0.mp4",
  ...
  homevideo: function () {
    var that = this;
    var url = "https://admin.hodays.com/api/activity/" + this.data.device + "/homeVideo/" + this.data.page + ""
    wx.request({
      url: url,
      method: "GET",
      header: {
  ...
  toAgree:function(e){
    ...
    for(let i of list){
      ...
      if (i.vid == id && i.agree){
        i.likesNum = i.likesNum + 1        
      } else if (i.vid == id && !i.agree){
        i.likesNum = i.likesNum - 1   
      }  
      this.setData({ list })       
    }
